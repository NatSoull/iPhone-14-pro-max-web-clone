    ...
    <div className="mx-3 md:mx-auto">
      ...
      <div className=" max-w-[1000px] mx-auto flex justify-between items-center mt-10 mb-24">
        ...
        <div className=" flex gap-2 items-center">
          <div className=" text-lg font-semibold mr-5">{fadeOff}</div>
          <div
            onClick={() => setFadeOff("deepPurple")}
            className={`${fadeOff === "deepPurple" ? "active" : null} w-5 h-5 bg-purple-500 rounded-full cursor-pointer select-none iphone-color-selector relative `}
          ></div>
          <div
            onClick={() => setFadeOff("gold")}
            className={`${fadeOff === "gold" ? "active" : null} w-5 h-5 bg-yellow-100 rounded-full cursor-pointer select-none iphone-color-selector relative`}
          ></div>
          <div
            onClick={() => setFadeOff("silver")}
            className={`${fadeOff === "silver" ? "active" : null} w-5 h-5 bg-slate-100 rounded-full cursor-pointer select-none iphone-color-selector relative `}
          ></div>
          <div
            onClick={() => setFadeOff("black")}
            className={`${fadeOff === "black" ? "active" : null} w-5 h-5 bg-gray-900 rounded-full cursor-pointer select-none iphone-color-selector relative `}
          ></div>
        </div>
      </div>

      <div className=" relative border border-black h-[570px] max-w-[770px] mx-auto">
        <img
          className={`${fadeOff === "deepPurple" ? "fade-off" : "fade-on"} absolute top-0 z-10`}
          src={iPhone14ProMaxDeepPurple}
        />
        <img
          className={`${fadeOff === "gold" ? "fade-off" : "fade-on"} absolute top-0`}
          src={iPhone14ProMaxGold}
        />
        <img
          className={`${fadeOff === "silver" ? "fade-off" : "fade-on"} absolute top-0`}
          src={iPhone14ProMaxSilver}
        />
        <img
          className={`${fadeOff === "black" ? "fade-off" : "fade-on"} absolute top-0`}
